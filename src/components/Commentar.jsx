...
import { MessageCircle, UserCircle2, Loader2, AlertCircle, Send, ImagePlus, X, Pin, Construction } from 'lucide-react';
import AOS from "aos";
...
const CommentForm = memo(({ onSubmit, isSubmitting, error }) => {
    ...
    const handleSubmit = useCallback((e) => {
        ...
        // NONAKTIFKAN - tampilkan pesan bahwa fitur sedang dalam pengembangan
        alert('Fitur komentar sedang dalam pengembangan. Terima kasih atas minat Anda!');
    ...
    return (
        <div className="space-y-6">
            {/* Banner Pengembangan */}
            <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-blue-500/20 to-indigo-500/20 border border-blue-500/30 rounded-xl" data-aos="fade-up" data-aos-duration="800">
                <Construction className="w-6 h-6 text-blue-400" />
                <div>
                    <h4 className="font-medium text-white">Fitur Sedang Dalam Pengembangan</h4>
                    <p className="text-sm text-gray-300 mt-1">Fitur komentar sedang dalam pengembangan. Anda dapat mengisi form di bawah, namun komentar tidak akan dikirim.</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                    ...
                    className="relative w-full h-12 bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl font-medium text-white overflow-hidden group transition-all duration-300 hover:scale-[1.02] hover:shadow-lg active:scale-[0.98] cursor-pointer"
                >
                    <div className="absolute inset-0 bg-white/20 translate-y-12 group-hover:translate-y-0 transition-transform duration-300" />
                    <div className="relative flex items-center justify-center gap-2">
                        <Send className="w-4 h-4" />
                        <span>Kirim Komentar (Preview Mode)</span>
                    </div>
                </button>
            </form>
        </div>
...
const Komentar = () => {
    ...
    // NONAKTIFKAN - fungsi handleCommentSubmit diubah hanya untuk menampilkan alert
    const handleCommentSubmit = useCallback(async ({ newComment, userName, imageFile }) => {
        setError('');
        
        // Tampilkan alert bahwa fitur sedang dalam pengembangan
        alert('Fitur komentar sedang dalam pengembangan. Terima kasih atas minat Anda!');
        
        // JANGAN kirim data ke database
        return;
    }, []);
            ...
            <div className="p-6 border-b border-white/10" data-aos="fade-down" data-aos-duration="800">
                <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-white">
                        ...
                        <span className="ml-3 text-sm font-normal text-blue-300 bg-blue-500/20 px-3 py-1 rounded-full">
                            Preview Mode
                        </span>
                    </h3>
                </div>
                ...
                <div className="space-y-4 h-[328px] overflow-y-auto overflow-x-hidden custom-scrollbar pt-1 pr-1" data-aos="fade-up" data-aos-delay="200">
                    ...
                    {comments.length === 0 && !pinnedComment ? (
                        <div className="text-center py-8" data-aos="fade-in">
                            ...
                            <p className="text-gray-400">No comments yet. Comments are currently in development.</p>
                        </div>
                    ) : (
