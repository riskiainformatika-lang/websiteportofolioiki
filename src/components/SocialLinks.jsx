...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://linktr.ee/riskiapriansyah22",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@riskiaprnsyhh",
    icon: Instagram,
    url: "https://www.instagram.com/riskiaprnsyhh?igsh=MTljem1vdjVmaXdleg==",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@riskiapriansyah",
    icon: Youtube,
    url: "https://youtube.com/@riskiapriansyah22?si=FZF_x3Mimm6Q3hrE",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@riskiapriansyah",
    icon: Github,
    url: "https://github.com/riskiainformatika-lang/WEBSITEBYIKI",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@riskiaprnsyhh?_r=1&_t=ZS-92pmfIkItBw",
    color: "black",
